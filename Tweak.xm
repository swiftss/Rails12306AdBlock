...
%ctor {
    @autoreleasepool {
        // Recovery baseline: do not hook or mutate any app object or view.
        RABLog(@"loaded stage=recovery-no-hooks bundle=%@ executable=%@ home=%@", NSBundle.mainBundle.bundleIdentifier,
